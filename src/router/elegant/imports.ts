...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  asset_project: () => import("@/views/asset/project/index.vue"),
  ...
  "manage_user-record": () => import("@/views/manage/user-record/index.vue"),
  manage_user: () => import("@/views/manage/user/index.vue"),
  "multi-menu_first_child": () => import("@/views/multi-menu/first_child/index.vue"),
  "multi-menu_second_child_home": () => import("@/views/multi-menu/second_child_home/index.vue"),
  "ops-manage_approve-task": () => import("@/views/ops-manage/approve-task/index.vue"),
  ...
  "ops-manage_task-log": () => import("@/views/ops-manage/task-log/index.vue"),
